function view_question(qid)
{
  	...
  	$.ajax({
				url: SITE_URL+"course_con/get_question_details/"+qid, 
				async:false,
				success: function(result){
					$("#popup_title").html("Question Details");
					$("#selDispo").attr("data-target","#appts_popup_q");
					$("#appts-details").html(result);
					$("#appts_popup_q").modal('toggle');
				}
			});	
}
			  ...
			  var qid=$(this).attr('id');
				...
				//var qid=this.id;
                   ...
                   //alert("Confirm result: "+result);
				   	...
				   	$.ajax({
				url: SITE_URL+"course_con/delete_question/"+qid, 
				async:false,
				success: function(result){

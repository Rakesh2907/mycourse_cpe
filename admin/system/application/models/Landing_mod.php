...
public function get_bundles()
	...
	public function get_bundles_courses($bundles_id)
	{ 
	         $bid = explode(',',$bundles_id);
		    $this->db->select("b.bundle_courses");
			$this->db->from("bundles AS b");
			//$this->db->join("us_state AS st", "st.state_id = b.state_id", "inner");
			$this->db->where_in("bundle_id",$bid);
	...
	public function update_bundle($data_update,$bundle_id)
	{
	 ...
	 public function add_landing_user($data)
	 {
		   $this->db->insert("landing_bundle_user", $data); 
		   return $this->db->insert_id();
	 }

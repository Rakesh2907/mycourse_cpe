...
<!-- BEGIN LOGO -->
<div class="logo">
      <div style="font-size:22px; color:#FFF;">CPE<span style="color:#F00">NATION</span></div>
</div>
<!-- END LOGO -->
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url()?>login_con/check_login" method="post">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 <?php echo date("Y"); ?> &copy; CPENATION - Admin.
</div>
<!-- END COPYRIGHT -->

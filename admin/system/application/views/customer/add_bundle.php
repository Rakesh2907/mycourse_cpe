    ...
    <div class="portlet box green">
      ...
      <div class="portlet-body form"> 
       ...
       <?php  
			...
			echo form_open('customer_con/add_bunddle_order',$attributes);
		    ...
		    $data_course = array();
			$data_bundle[''] = '--Select Bundle--';
			foreach($bundle_details as $bundle)
			{
				$bundle_id = $bundle['bundle_id'];
				$data_bundle[$bundle_id] = $bundle['bundle_name'];
			}		
			$bundle_data = set_value('bundle_id');	
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                   <label class="control-label">bundles<span class="required" aria-required="true"> *</span></label>
                     <?php echo form_dropdown('bundle_id',$data_bundle,$bundle_data,'class="select2_category form-control cd" tabindex="0" required="required"');?>
          ...
          <div class="form-actions right">
            <div class="row">
                  <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="<?php echo base_url();?>faq_con/<?php //echo $bundleid;; ?>"><button type="button" class="btn default">Cancel</button></a>
                  </div>
...
$( ".cd" ).change(function() {
  var bundleid=$( ".cd" ).val();
  	...
  	$.ajax({
				url: SITE_URL+"customer_con/get_bundle_amount/"+bundleid, 
				async:false,

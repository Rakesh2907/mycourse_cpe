...
<?php  
			...
			echo form_open('index_con/customer_listing/',$attributes);
				$arr_submit = array(
								'name' => 'submit',
								'value' => $pagetitle,
								'class' => 'btn green'
  ...
  <div class="form-group">
       <label class="control-label">From</label>
				  ...
				  <input type="text" class="form-control" id="fromdate" name="fromdate" required="required" value="<?php echo date('d-m-Y',strtotime($sdate)); ?>" readonly >
  ...
  <label class="control-label">To</label>
                  <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" >
				  <input type="text" class="form-control" id="todate" name="todate" required="required" value="<?php echo date('d-m-Y',strtotime($todate)); ?>" readonly >
				  <span class="input-group-btn">
				  <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
				  </span>
				</div>
			...
			?>
                    <tr class="odd gradeX">
                     ...
                     <?php echo date('m-d-Y',strtotime($row['created'])); ?>
                      ...
                      <td>
                    <a class="btn default btn-xs purple" target="_blank" href="<?php echo base_url();?>customer_con/custome_orders/<?php echo $row['id'];?>" alt="Orders" title="Orders"/><i class="icon-basket-loaded"></i></a>
                      </td>
                    </tr>
            <?php
				 }

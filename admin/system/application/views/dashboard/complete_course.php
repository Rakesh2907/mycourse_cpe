<?php 
//echo "<pre>";print_r($completed_course);die;
$data_state = array();
...
<?php  
			...
			echo form_open('index_con/completed_course/',$attributes);
				$arr_submit = array(
								'name' => 'submit',
								'value' => $pagetitle,
								'class' => 'btn green'
  ...
  <div class="form-group">
    ...
    <div class="form-group">
                     ...
                     <?php echo form_dropdown('certificate',$data_certif,'','class="select2_category form-control" tabindex="0"');?>
  ...
  <!--</form>-->
        ...
        <table class="table table-striped table-bordered table-hover" id="sample_2">
          ...
          <tbody>
            <?php 
				$top_customer1 = count($completed_course);
				if($top_customer1 > 0)
				{ 
				  foreach($completed_course as $row )
				  {
					  if(isset($row['state']))
					  {
			...
			?>
                    <tr class="odd gradeX">
                     ...
                     <!-- <td><?php //echo $row['id']?></td>-->
                      ...
                      <td>
                     <?php echo date('m-d-Y',strtotime($row['completed_date'])); ?>
                      </td>
                    </tr>
            <?php
				 }

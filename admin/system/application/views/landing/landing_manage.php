      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group">
                <a href="<?php echo base_url();?>landing_con/add_bundle"><button id="sample_editable_1_new" class="btn green"> Add New <i class="fa fa-plus"></i> </button></a>
              </div>
            </div>
            <!--<div class="col-md-6">
        ...
        <?php } ?>
        <table class="table table-striped table-bordered table-hover" id="landing_table">
          <thead>
            <tr>
			...
			?>
                    <tr class="odd gradeX">
                     <!-- <td><input type="checkbox" class="checkboxes" value="1"/></td>-->
                      ...
                      <td>
                        <a href="<?php echo base_url();?>landing_con/edit_bundle/<?php echo $row['bundle_id'];?>" class="btn default btn-xs purple" title="Edit" alt="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a class="btn default btn-xs red" href="javascript:void(0)" onclick="delete_landing_bundle(<?php echo $row['bundle_id'];?>)" alt="Delete" title="Delete"/><i class="fa fa-trash-o"></i></a>&nbsp;&nbsp;<a href="<?php echo base_url();?>landing_con/send_bundle_mail/<?php echo $row['bundle_id'];?>" class="btn default btn-xs purple" title="Send Mail" alt="Send Mail"><i class="fa fa-envelope"></i></a>
                      </td>
                    </tr>
            <?php
				 }

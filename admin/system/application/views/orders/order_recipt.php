...
<tr>
  ...
  <tr>
    <td><img style="width:200px;" src="<?php echo $this->config->item('base_url_asset')?>uploads/logo.jpg" /></td>
...
<?php echo $cemail;?></td>
         ...
         <tr>
            ...
            <?php }else if($detail['purchase_type']=='Course'){
             ...
             <?php }else if($detail['purchase_type']=='Subscription'){ 
			 		$getdetails = $this->subcription_mod->get_subcription_details($detail['course_id']);
  ...
  <tr>
  <?php if($order_details[0]['order_tax'] != 0.00) {?>
       <td>Tax</td>
       <td>&nbsp;</td>
       <td style="text-align:right;">$<?php echo $order_details[0]['order_tax']; ?></td>
      </tr>
   <?php } ?>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td style="text-align:right;"><strong>$<?php echo number_format((($order_details[0]['order_total']+$order_details[0]['order_tax'])-$order_details[0]['discount']),2); ?></strong></td>
  </tr>
</table>

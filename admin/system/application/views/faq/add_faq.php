    ...
    <div class="portlet box green">
      ...
      <div class="portlet-body form"> 
       ...
       <?php  
			...
			echo form_open('faq_con/add_faq',$attributes);
			
			$cmstitl = set_value('ques');	
			$data_ques = array(
						  		 'name'         => 'ques',
								  'id'          => 'ques',
								  //'value'       => $ques,
          ...
          <div class="form-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label">FAQ For</label>
                  <?php echo form_dropdown('type',$data_type,'','class="form-control select2"'); ?>
                </div>
              </div>
          </div>
          ...
          <div class="form-actions right">
            <div class="row">
                  <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="<?php echo base_url();?>faq_con/<?php //echo $courseid;; ?>"><button type="button" class="btn default">Cancel</button></a>
                  </div>

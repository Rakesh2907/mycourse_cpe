    ...
    <div class="portlet box green">
      ...
      <div class="portlet-body form"> 
       ...
       <?php  
			...
			echo form_open('course_con/edit_chapter',$attributes);
			
			
			$courseid = $chapter_details[0]['course_id'];
			...
			$data_chptname = array(
						  		 'name'         => 'chptname',
								  'id'          => 'chptname',
								  'value'       => $chapter_details[0]['chapter_name'],
								  'class'		=> 'form-control',
								  'placeholder'		=> 'Chapter Name'
								  );
								  
			$chptdesc = set_value('chptdesc');	
			$data_chptdesc = array(
						  		 'name'         => 'chptdesc',
								  'id'          => 'chptdesc',
								  'value'       => $chapter_details[0]['chapter_desc'],
								  'rows'        => '5',
      							  'cols'        => '10',
								   'class'		=> 'form-control',
			...
			$data_back_color = array(
								  ...
								  'id'          => 'hue-demo',
								  'data-control' =>"hue",
								  'value'       => $chapter_details[0]['back_color'],
	   ...
	   ?>
          <div class="form-body">
           <input type="hidden" name="cptid" id="cptid" value="<?php echo $chapter_id;?>" />
                ...
                <div class="form-group">
                  <label class="control-label">Chapter Description<span class="required" aria-required="true"> *</span></label>
                    <?php //echo form_textarea($data_chptdesc); ?>
                     <?php echo $this->ckeditor->editor("chptdesc",$data_chptdesc['value']); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label">Status<span class="required" aria-required="true"> *</span></label>
                    <?php echo form_dropdown('status',$data_status,$chapter_details[0]['status'],'class="select2_category form-control" data-placeholder="Select status"');?>

    ...
    <div class="portlet box green">
      ...
      <div class="portlet-body form"> 
       ...
       <?php  
			...
			echo form_open_multipart('subcription_con/edit_subcription',$attributes);
			...
			$data_subcription_name = array(
						  		 'name'         => 'title',
								  'id'          => 'title',
								  'value'       => $subcription_details[0]['title'],
								  'class'		=> 'form-control',
								  'required'    => 'required',
			...
			$data_subcription_price = array(
						  		  'name'        => 'price',
								  'id'          => 'price',
								  'value'       => $subcription_details[0]['price'],
								  'rows'		=> '2',
								  'cols'		=> '10',
								  'class'		=> 'form-control',
								  'required'    => 'required',
			...
			$data_duration = array(
						  		 'name'         => 'duration',
								  'id'          => 'duration',
								  'value'       => $subcription_details[0]['duration'],
								  'class'		=> 'form-control',
								  'required'    => 'required',
	   ...
	   ?>
          <div class="form-body">
            ...
            <?php } ?>
             <input type="hidden" name="subscription_id" value="<?php echo $subcription_details[0]['subscription_id'];?>"/>
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="control-label">Status</label>
                   <?php echo form_dropdown('status',$data_subcription,$subcription_details[0]['status'],'class="select2_category form-control" tabindex="0"');?>
                </div>
              </div>
            </div>
          </div>

...
<body>
<table width="1050" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(<?php echo FRONT_IMAGE_ASSET; ?>images/certificate_template.png) no-repeat center top; background-size: 100% auto;font-family: 'Raleway', sans-serif;font-size:16px;color:#000000;height:665px;">
  <tr>
    <td valign="top" style="padding: 66px 40px 60px;"><table cellspacing="0" cellpadding="0" border="0" align="center">
        <tr>
          <td align="center"><img width="160" alt="CPE Nation" src="<?php echo FRONT_IMAGE_ASSET; ?>images/certificate_logo.png"></td>
        </tr>
        <tr>
